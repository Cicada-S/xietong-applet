				...
				<u-form-item label="不良信息" borderBottom border :required="true">
					<view class="king-flex king-flex__column">
						<view class="search-item king-flex" style="width:50%;margin:10rpx 0px;">
							<u-button type="primary" size="small" @click="() => showBadItem = true" text="新增"></u-button>
						...
						<u-table align="left">
							...
							<u-checkbox-group placement="column" @change="changeCheckBox">
								<u-tr v-for="(item,index) in formData.invDetailList" :key="index">
									<u-td style="width:13%">
										<u-checkbox :name="item.BadItemId" :checked="selectRowKeys.includes(item.BadItemId)" ></u-checkbox>
									</u-td>
