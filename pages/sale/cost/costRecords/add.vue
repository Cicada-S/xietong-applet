...
export default {
  ...
  onLoad(options) {
    ...
    uni.setNavigationBarTitle({
      title: `${this.formData.id ? "编辑" : "新增"}成本分析`,
    })
  },
  methods: {
    changeWorkStep(e) {
      this.formData.partnersId = e.id
    ...
    changecostType(e) {
      ...
      this.costTypeName = e.typeName
    },
    submit() {
      const url = this.formData.id ? this.$api.editCostRecords : this.$api.addCostRecords
